...
export class CounterFacadeService implements OnDestroy {
  ...
  // = SIDE EFFECTS =========================================================
  isTicking = this.counterState.pipe(selectDistinctState<CounterState, boolean>({ key: CounterStateKeys.isTicking }));
  tickSpeed = this.counterState.pipe(selectDistinctState<CounterState, number>({ key: CounterStateKeys.tickSpeed }));
